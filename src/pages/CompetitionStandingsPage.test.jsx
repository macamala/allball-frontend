...
vi.mock('../api.js',()=>({getStandings:mocks.getStandings,getJSON:vi.fn(async()=>({available:true,events:[],teams:[],groups:[],table_views:{}}))}));
vi.mock('../hooks/useVisiblePoll.js',()=>({default:(callback,interval,enabled)=>{if(enabled===undefined)mocks.poll=callback;}}));
